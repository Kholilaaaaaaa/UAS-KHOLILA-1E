...
public class UAS1E {
    public static void main(String[] args) {
        ...
        // Inisialisasi ArrayList untuk menyimpan pejualan masing-masing bahan bakar
        ArrayList<Integer> penjualanPertalite = new ArrayList<>();
        ArrayList<Integer> penjualanPertamax = new ArrayList<>();
        ArrayList<Integer> penjualanPertamxTurbo = new ArrayList<>();
        ArrayList<Integer> penjualanPertadex = new ArrayList<>();

        // Looping selama 8 jam (pukul8 - 16)
        for (int jam = 8; jam <= 16; jam++) {
            ...
            if (kapasitasStok[2] - jumlahPenjualan >= 0) {
                penjualanPertamxTurbo.add(jumlahPenjualan);
            ...
            if (jam % 3 == 0) {
                ...
                System.out.println("Pertamax: Turbo " + penjualanPertamxTurbo);
                ...
                System.out.println("Total penjualan: " + (penjualanPertalite.stream().mapToInt(Integer::intValue).sum() +
                        ...
                        penjualanPertamxTurbo.stream().mapToInt(Integer::intValue).sum() +
